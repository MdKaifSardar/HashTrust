...
const ReviewDataComp: React.FC = () => {
  ...
  return (
    <div className="min-h-screen justify-center items-center h-full flex flex-col gap-8 w-full relative">
      ...
      <div className="absolute top-0 left-0 w-full flex justify-between items-center px-2 py-2 z-10">
        ...
        <button
          ...
          className="flex items-center justify-center w-12 h-12 rounded-full font-semibold bg-green-600 text-white hover:bg-green-700"
        >
          <FiChevronRight size={28} />
        </button>
      </div>

      <div className="bg-green-300 h-full w-full flex flex-col justify-center items-center"> 
        <h2 className="text-3xl font-bold mb-2 text-blue-700 text-center">
          Review Your Data
        </h2>
        <div className="w-full bg-red-400 flex flex-col sm:flex-row justify-center items-center ">
