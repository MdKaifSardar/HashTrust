  ...
  return (
    <div className="bg-transparent flex flex-col justify-center items-center w-full min-h-screen h-full rounded-lg relative">
      ...
      <div className="mt-14 w-full flex flex-col items-center">
        ...
        {/* Professional display of extracted data */}
        {hasExtractedData && (
          <div className="flex p-[1rem] flex-col justify-center items-center bg-white rounded-lg shadow mb-4 border border-blue-100">
